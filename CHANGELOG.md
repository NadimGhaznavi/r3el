...
## [6.1.0] - 2026-09-26 @ 10:23

### Added
- Launch catalogue media links through a Linux VLC handler, with a standalone per-user desktop installer.

## [6.0.1] - 2026-09-26 @ 10:17
...
### Added
- Add Random Search beside Category Search, showing six random movies, TV shows, or episodes in place of Recent additions.

## [5.2.2] - 2026-09-26 @ 08:52
...
### Changed
- Center the Search Index heading and contents.

### Fixed
- Keep Search Index spacing outside the links so only the letters are clickable.
