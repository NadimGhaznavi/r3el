...
class SubmissionHandler:
    ...
    def handle(self, request: ZMQMsg) -> dict:
        ...
        log.write(Categories.Tool.SUBMISSION_HANDLER, Names.TOOL_RECEIVED, data, source='SubmissionHandler')
        try:
        ...
        log.write(Categories.Tool.SUBMISSION_HANDLER, Names.SUBMISSION_ACCEPTED,
                  result, source='SubmissionHandler')
        return result
