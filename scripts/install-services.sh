...
modules=(
    ...
    server/static/r3el.png server/templates/control.html server/templates/logo.html
    ...
    server/templates/messages/multiple_choice.html
    ...
    app/TVEpisodeMapping.py app/prompts/DirectoryEpisodesTV.py
    app/Prompt.py
